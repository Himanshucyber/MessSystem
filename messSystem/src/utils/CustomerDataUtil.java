...
public class CustomerDataUtil {
	...
	public static  Map<Integer, Customer> populateCustomer () throws InvalidInput {
		...
		customerMap.put(2, InputValidation.validateAllInput(2,"himanshu","Pandey","himans25@gmail.com","password2","Akurdi,Pune","2024-01-02","0998765431","Monthly"));
		...
		customerMap.put(6, InputValidation.validateAllInput(6,"apurva","Dewedi","Apurva925@gmail.com","password6","Dhanori,Pune","2023-12-12","0998765431","YEAR"));
		customerMap.put(7, InputValidation.validateAllInput(7,"Rama","Dewedi","DewediRama925@gmail.com","password7","Pimpari,Pune","2024-01-02","0998765431","HALFYEAR"));
